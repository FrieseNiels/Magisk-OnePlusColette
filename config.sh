...
print_modname() {
  ui_print "***************************************"
  ui_print "***************************************"
  ui_print "   Magisk Module: Pixel Bootanimation"
  ui_print "   ----------------------------------"
  ui_print "   "
  ui_print "   This Magisk module replaces the "
  ui_print "   /system/media/bootanimation.zip"
  ui_print "   with the one from OnePlus Colette."
  ui_print "                                       "
  ui_print "   packed for Magisk by NielsvdS"
  ui_print "   (XDA user NielsvdS)"
  ui_print "***************************************"
  ui_print "***************************************"
}
